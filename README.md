---
website: "ECOS Machico"          # Entre as aspas escreve o nome do website
date: "31/12/1999"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://ecosmachico.pt"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://ecosmachico.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
